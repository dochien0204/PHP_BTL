      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input class="ms-1" type="checkbox"> Remember Me
            </label>
          </div>
        </div>
